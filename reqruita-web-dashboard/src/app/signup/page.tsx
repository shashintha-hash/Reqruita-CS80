        ...
        <div className="w-1/2 flex-col items-center justify-center text-white px-8 hidden lg:flex gap-10">
          <div className="relative">
            ...
            <img
              ...
              alt="Reqruita Logo"
              className="relative w-36 h-36 rounded-[2rem] bg-white/95 shadow-2xl shadow-purple-900/30 p-1 ring-1 ring-white/20"
            />
          </div>
          ...
          <p className="text-white/70 text-base max-w-sm text-center leading-relaxed">
            Join thousands of companies finding top talent with Reqruita.
          </p>
        </div>
          ...
          <div className="w-full max-w-[580px] bg-white/[0.97] backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/10 border border-white/60 px-10 py-8 overflow-y-auto max-h-[96vh] custom-scrollbar">
            ...
            <form onSubmit={handleSubmit} className="space-y-[18px]">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <img
                    src="https://www.svgrepo.com/show/475655/microsoft-color.svg"
                    className="w-5 h-5"
                    alt="Microsoft"
                  />
                  <span className="text-sm font-medium text-gray-600 group-hover:text-gray-800">
